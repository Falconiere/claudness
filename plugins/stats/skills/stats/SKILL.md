---
name: stats
description: "On-demand report of measured Claude Code token/cost/cache usage and toolu activity, computed from the session transcripts. Use when asked 'what did this week cost', 'which project/model burns the most tokens', 'my cache-hit rate', 'usage stats', or '/stats'. Numbers are measured from the session log, not estimated."
---
