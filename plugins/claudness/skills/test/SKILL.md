---
name: test
description: Use when writing or organizing tests for any feature or bugfix. Enforces the claudness test layout (TS __tests__/, Rust tests/), real-world data only (NO mocks), and test-first discipline. Native claudness workflow; fourth phase of brainstorm → plan → execute → test.
---

# Test

Fourth phase of the claudness workflow. Tests are written **with** the code, not after — this skill defines how and where.
