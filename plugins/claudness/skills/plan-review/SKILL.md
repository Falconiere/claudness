---
name: plan-review
description: "Use to review an implementation plan BEFORE writing code — check it's executable, complete, and won't collapse on contact with the codebase. Tells: \"review the plan\", \"is this plan ready\", \"poke holes in the plan\", \"did we miss a step\". Pairs with the `plan` skill; runs between plan and execution in the claudness workflow."
---
