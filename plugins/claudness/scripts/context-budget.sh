...
run_docs() {
  check_doc session-start      plugins/claudness/hooks/docs/session-start.md      110
  check_doc post-compaction    plugins/claudness/hooks/docs/post-compaction.md     28
  check_doc session-start-ts   plugins/claudness/hooks/docs/session-start-ts.md    30
  check_doc session-start-rust plugins/claudness/hooks/docs/session-start-rust.md  36
}

run_skills() {
  # Trimmed skills: word ceiling + trigger phrases that MUST survive the trim.
  check_skill brainstorm       plugins/claudness/skills/brainstorm/SKILL.md       90 "where do I even start;help me scope it;think through the approach and tradeoffs"
  check_skill spec             plugins/claudness/skills/spec/SKILL.md             70 "write the spec;document the design"
  check_skill spec-review      plugins/claudness/skills/spec-review/SKILL.md      60 "review the spec;poke holes in this spec"
  check_skill plan-review      plugins/claudness/skills/plan-review/SKILL.md      55 "review the plan;poke holes in the plan"
  check_skill execution-review plugins/claudness/skills/execution-review/SKILL.md 60 "review the execution;is this done"
