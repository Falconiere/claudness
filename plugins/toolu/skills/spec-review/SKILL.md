...
Read the spec (under `docs/toolu/specs/`) and run it against the checklist. For each item, ask *would a competent builder be blocked or misled by this?* — that's the bar, not stylistic preference.
