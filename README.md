...
[![Tests](https://img.shields.io/badge/tests-485%20passing-brightgreen)](#testing)
...
The hook engine and language gates are covered by **485 [bats](https://github.com/bats-core/bats-core) tests** across 34 suites, run in CI on every push:
